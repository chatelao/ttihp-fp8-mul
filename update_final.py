...
ts4_content = f"""### Test Sequence 4: Vector Packing (FP4 E2M1) - Standard Protocol
...
import re
pattern = re.compile(r'### Test Sequence 4: Vector Packing.*?### Test Sequence 6: OCP MX\+', re.DOTALL)
new_content = pattern.sub(ts4_content + "### Test Sequence 6: OCP MX+", content)
