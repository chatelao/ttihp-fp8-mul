...
module tt_um_chatelao_fp8_multiplier #(
    ...
    wire acc_clear = ena && strobe && (logical_cycle <= 7'd2) && (state != STATE_STREAM) && (logical_cycle == 7'd2);
    ...
    reg [7:0] sticky_byte;
    wire [6:0] output_byte_idx = logical_cycle - capture_cycle;
    always @(*) begin
