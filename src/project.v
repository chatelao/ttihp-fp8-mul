...
module tt_um_chatelao_fp8_multiplier #(
    ...
    wire mul_nan_lane0, mul_inf_lane0;
    wire mul_nan_lane1, mul_inf_lane1;
    ...
    wire mul_nan_lane0_val, mul_inf_lane0_val;
    wire mul_nan_lane1_val, mul_inf_lane1_val;
    /* verilator lint_on UNUSEDSIGNAL */
    ...
    wire effective_nan = nan_sticky || (inf_pos_sticky && inf_neg_sticky);
    wire [31:0] special_override = effective_nan  ? 32'h7FC00000 :
                                   inf_pos_sticky ? 32'h7F800000 :
                                   inf_neg_sticky ? 32'hFF800000 :
                                   32'd0;

    wire [31:0] final_scaled_result = (effective_nan || inf_pos_sticky || inf_neg_sticky) ? special_override :
