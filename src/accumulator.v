...
module accumulator #(
    ...
    input  wire [39:0] load_data,     // The 40-bit value to be loaded into the serialization register.
    ...
    // Ensure REG_WIDTH is at least 40 bits to support consistent 4-byte serialization.
    localparam REG_WIDTH = (WIDTH > 40) ? WIDTH : 40;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            acc_reg <= {{(REG_WIDTH-40){load_data[39]}}, load_data};
