...
async def test_ofp8_e4m3_compliance(dut):
    ...
    # 32 * 448 = 14336.0 -> 0x465FC000
    await run_mac_test(dut, 0, 0, [0x7E]*32, [0x38]*32, expected_override=0x465FC000)
    ...
    # 32 * 1.125 * 2^-9 = 1.125 * 2^-4 = 0.0703125 -> 0x3D900000
...
async def test_ofp8_rounding_compliance(dut):
    ...
    # 3 * 2^-9 = 0.005859375
    # 32 * 0.005859375 = 0.1875 -> 0x3E400000
    await run_mac_test(dut, 0, 0, [0x03]*32, [0x38]*32, round_mode=3, expected_override=0x3E400000)
