...
|--------|------------------|-------------|
| `ui_in[7:0]` | 28, 27, 23, 22, 21, 20, 19, 18 | Scale A / Elements A |
| `uo_out[7:0]` | 35, 34, 33, 32, 31, 30, 29, 24 | Serialized Result |
| `uio[7:0]` | 42, 41, 40, 39, 13, 10, 9, 8 | Scale B / Elements B |
...
A comprehensive list of terms and acronyms used in this project can be found in the [Project Glossary](documentation/GLOSSARY.md).
