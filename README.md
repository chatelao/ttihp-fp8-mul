...
The bitstream is automatically generated by the GitHub Action defined in `.github/workflows/gowin.yaml`. For manual building, flashing, and testing, see the [Tang Nano 4K Guide](docs/hardware/TANG_NANO_4K_GUIDE.md).
