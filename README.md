...
- [Tang Nano 4K Deployment & Testing Guide](docs/hardware/TANG_NANO_4K_GUIDE.md)
...
For detailed build, flash, and test instructions, see the **[Tang Nano 4K Deployment & Testing Guide](docs/hardware/TANG_NANO_4K_GUIDE.md)**.
