...
package riscv_instr;
  ...
  /* FP4 (Xff4) Instructions - CUSTOM0 (0x0B) */
  localparam logic [31:0] FADD_P             = 32'b0000000??????????000?????0001011;
  localparam logic [31:0] FSUB_P             = 32'b0000100??????????000?????0001011;
  localparam logic [31:0] FMUL_P             = 32'b0001000??????????000?????0001011;
  localparam logic [31:0] FDIV_P             = 32'b0001100??????????000?????0001011;
  localparam logic [31:0] VFADD_P            = 32'b1000001??????????000?????0001011;
  localparam logic [31:0] VFSUB_P            = 32'b1000010??????????000?????0001011;
  localparam logic [31:0] VFMUL_P            = 32'b1000011??????????000?????0001011;
  localparam logic [31:0] VFMAC_P            = 32'b1001000??????????000?????0001011;
  localparam logic [31:0] VFSUM_P            = 32'b1000111??????????000?????0001011;
