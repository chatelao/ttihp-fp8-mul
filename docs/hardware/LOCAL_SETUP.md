...
# Place and Route
nextpnr-gowin --json build/gowin.json --write build/gowin_pnr.json --device GW1NSR-LV4CQN48PC6/I5 --family GW1NS-4 --top tt_gowin_top --freq 20 --cst src_gowin/tangnano4k.cst
# Pack
