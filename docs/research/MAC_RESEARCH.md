...
| **RISC-V ZvfofpXmin (Est.)** | ~15,000 Gates | [Gap Analysis](../integration/ZvfofpXmin_GAP.md) | Proposed minimal vector extension for OCP MX. | Includes VRF and ISA decoding overhead. |
