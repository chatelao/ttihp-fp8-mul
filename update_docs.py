...
# Update Test Sequence 4
ts4_old = r"""### Test Sequence 4: Vector Packing \(FP4 E2M1\) - Standard Protocol
...
content = re.sub(ts4_old, ts4_new, content)

# Update Test Sequence 5
ts5_old = r"""### Test Sequence 5: FP4 Fast Lane - Short Protocol
...
content = re.sub(ts5_old, ts5_new, content)
